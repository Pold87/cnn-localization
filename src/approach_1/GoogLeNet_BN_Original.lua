...
part1:add(SpatialMaxPooling(3,3,2,2)) -- 64x112x112 -> 64x56x56
part1:add(nn.SpatialBatchNormalization(64))
part1:add(ReLU(true))
part1:add(SpatialConvolution(64,192,3,3,1,1,1,1)) -- 64x56x56 -> 192x56x56
part1:add(SpatialMaxPooling(3,3,2,2)) -- 192x56x56 -> 192x28x28
...
auxClassifier1:add(nn.SpatialAveragePooling(5,5,3,3))
auxClassifier1:add(nn.SpatialConvolution(576,128,1,1))
auxClassifier1:add(nn.ReLU(true))
...
auxClassifier1:add(nn.Linear(768,350))
