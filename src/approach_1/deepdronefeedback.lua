...
------------------------------------------------------------------------
local DeepDroneFeedback, parent = torch.class("dp.DeepDroneFeedback", "dp.Feedback")
DeepDroneFeedback.isDeepDroneFeedback = true

function DeepDroneFeedback:__init(config)
   config = config or {}
