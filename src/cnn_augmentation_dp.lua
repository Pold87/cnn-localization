require 'dp'
local UAV = require 'cnnaugmentation_dp_data'
...
cmd:text('Example:')
cmd:text('$> th cnn_augmentation_dp.lua --batchSize 128 --momentum 0.5')
cmd:text('Options:')
...
--[[data]]--
ds = dp.UAVCoordinates()--{input_preprocess = input_preprocess, valid_ratio = opt.validRatio}
--ds = dp.FaceDetection()
...
xp = dp.Experiment{
   ...
   observer = {
      dp.FileLogger(),
      dp.EarlyStopper{
         error_report = {'validator', 'feedback', 'uavcoordinate', 'mse'},
